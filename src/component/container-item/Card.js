  ...
  return (
    <div className="card-container">
      <div className="card-logo-title">
        <img className="card-logo-title-image" src={item.image} alt="logo" />
        <div className="card-logo-title-name">
          <h2 className="card-logo-title-name-text">{item.name}</h2>
          {item.created_at && (
            <p className="card-logo-title-name-date">
      ...
      <p className="card-logo-description">{item.description}</p>
      <div className="card-campaigns-leads">
        <svg
        ...
        <p className="margin-right-6 campaign-counts">{item.campaigns_count} Campaigns</p>
        <svg
          className="margin-right-6"
          width="16"
          height="14"
        ...
        <p className="leads-counts"> {item.leads_count} Leads</p>
      </div>
    </div>
  );
};
